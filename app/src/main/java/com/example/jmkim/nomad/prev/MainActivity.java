                        ...
                        FirebaseDatabase.getInstance().getReference()
                                ...
                                .addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        mainBoardInfos.add(new MainBoardInfo(boards.get(final_i).publisher, userModel.get(0).profileImageUrl
                                                , boards.get(final_i).title, boards.get(final_i).country));
